  ...
  return (
    <div className="space-y-8">
      <section className="ptsp-card p-6 md:p-8">
        ...
        <h1 className="mt-3 text-2xl font-bold text-slate-900 md:text-4xl">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="ptsp-card space-y-4 p-5">
          <h2 className="text-lg font-bold text-slate-900">Informasi Kantor</h2>
        ...
        <div className="ptsp-card p-5">
          <h2 className="text-lg font-bold text-slate-900">Kanal Pengaduan</h2>
      ...
      <section className="ptsp-card p-5 md:p-6">
        <h2 className="text-lg font-bold text-slate-900">FAQ Singkat</h2>
